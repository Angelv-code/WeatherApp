...
searchBtn.addEventListener("click", () => {
    let cityName = cityInp.value;
    let finalURL = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=c169081b3524b9aa0a9459cfc922275e&units=metric`;
    ...
    .then((data) => {
        ...
        <h3 class = "api-text">Temperature </h3> <h3>${data.main.temp} - Celsius</h3>
        <h3 class = "api-text">Feels Like </h3> <h3>${data.main.feels_like} - Celsius</h3>
